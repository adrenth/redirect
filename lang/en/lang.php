...
return [
    ...
    'redirect' => [
        'from_url' => 'From URL',
        'from_url_comment' => 'Enter an URL to match. When match type is set to \'Placeholders\' you can use placeholders such as {category} or {id}.',
        'to_url' => 'To URL',
        'to_url_comment' => 'Enter the URL to redirect to. Placeholders can be used if match type is set to \'Placeholders\'',
        ...
        'placeholder_comment' => 'The placeholder name provided in the \'From URL\' field. E.g. category or id',
